...
def check_lib(lib, unique_words, word_to_books):
    if sorted(lib.distinct_words("book1")) == unique_words[0] and sorted(lib.distinct_words("book2")) == unique_words[1]:
    ...
    if lib.search_keyword(word) == word_to_books[word]:
